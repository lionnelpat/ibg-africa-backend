...
import { EnseignantService, EntityArrayResponseType } from '../service/enseignant.service';
...
export class EnseignantComponent implements OnInit {
  ...
  enseignants = signal<IEnseignant[]>([]);
  isLoading = false;
  ...
  protected readonly enseignantService = inject(EnseignantService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: IEnseignant): number => this.enseignantService.getEnseignantIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.enseignants.set(dataFromBody);
  }
