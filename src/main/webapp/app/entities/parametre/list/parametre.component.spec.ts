...
import { sampleWithRequiredData } from '../parametre.test-samples';
...
describe('Parametre Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.parametres()[0]).toEqual(expect.objectContaining({ id: 6734 }));
  });

  describe('trackId', () => {
    it('should forward to parametreService', () => {
      const entity = { id: 6734 };
      jest.spyOn(service, 'getParametreIdentifier');
      const id = comp.trackId(entity);
      expect(service.getParametreIdentifier).toHaveBeenCalledWith(entity);
