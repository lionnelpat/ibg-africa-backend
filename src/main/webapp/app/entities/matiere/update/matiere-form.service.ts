...
type MatiereFormDefaults = Pick<NewMatiere, 'id' | 'actif'>;

type MatiereFormGroupContent = {
  id: FormControl<IMatiere['id'] | NewMatiere['id']>;
  intitule: FormControl<IMatiere['intitule']>;
  libelleLong: FormControl<IMatiere['libelleLong']>;
  libelleCourt: FormControl<IMatiere['libelleCourt']>;
  commentaire: FormControl<IMatiere['commentaire']>;
  actif: FormControl<IMatiere['actif']>;
};
...
export class MatiereFormService {
  createMatiereFormGroup(matiere: MatiereFormGroupInput = { id: null }): MatiereFormGroup {
    ...
    return new FormGroup<MatiereFormGroupContent>({
      ...
      intitule: new FormControl(matiereRawValue.intitule, {
        validators: [Validators.required, Validators.maxLength(100)],
      }),
      libelleLong: new FormControl(matiereRawValue.libelleLong, {
        validators: [Validators.maxLength(100)],
      }),
      libelleCourt: new FormControl(matiereRawValue.libelleCourt, {
        validators: [Validators.maxLength(50)],
      }),
      commentaire: new FormControl(matiereRawValue.commentaire, {
        validators: [Validators.maxLength(255)],
      }),
      actif: new FormControl(matiereRawValue.actif, {
        validators: [Validators.required],
      }),
    });
  }
