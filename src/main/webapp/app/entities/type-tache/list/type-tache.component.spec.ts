...
import { sampleWithRequiredData } from '../type-tache.test-samples';
...
describe('TypeTache Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.typeTaches()[0]).toEqual(expect.objectContaining({ id: 8191 }));
  });

  describe('trackId', () => {
    it('should forward to typeTacheService', () => {
      const entity = { id: 8191 };
      jest.spyOn(service, 'getTypeTacheIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTypeTacheIdentifier).toHaveBeenCalledWith(entity);
